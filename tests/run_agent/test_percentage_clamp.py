...
but missed the same unclamped pattern in other files. When token counts
overshoot the context length (possible during streaming or before compression
fires), users see >100% in /stats and gateway status.
"""
