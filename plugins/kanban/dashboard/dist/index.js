 ...
 *
 * Board view for the multi-agent collaboration board. Calls the plugin's
 * backend at /api/plugins/kanban/
      ...
      return h(Card, null,
        h(CardContent, { className: "p-6" },
          ...
          h("div", { className: "text-xs text-muted-foreground mt-2" },
            tx(t, "loadFailedHint",
              "Kanban storage is disabled in OraHermes until an Oracle-backed board is configured. If this persists, check the dashboard logs.")),
        ),
      );
    }
