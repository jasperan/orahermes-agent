...
_HERMES_CORE_TOOLS = [
    ...
    # Planning
    "todo",
    # Oracle-backed session history search
    "session_search", "semantic_recall",
...
TOOLSETS = {
    ...
    "memory": {
        "description": "Disabled in OraHermes until memory is Oracle-backed",
        "tools": [],
        "includes": []
    },

    "session_search": {
        "description": "Search and recall past conversations from Oracle Database, including semantic vector recall",
        "tools": ["session_search", "semantic_recall"],
        "includes": []
    },
    ...
    # External memory-provider toolsets are removed in OraHermes.
