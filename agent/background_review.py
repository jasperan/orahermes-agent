...
def _run_review_in_thread(
    ...
    try:
        with open(os.devnull, "w", encoding="utf-8") as _devnull, \
            ...
            # touching disabled persistent-memory providers. Without it, the fork's
            ...
            # redirected so background thread teardown stays silent.  The
            # finally block
        ...
        # Re-open devnull here so any teardown output (background thread joins)
        # stays silent even
