...
KANBAN_GUIDANCE = (
    ...
    "they write through the configured Hermes coordination backend and work "
    "regardless of terminal backend (local/docker/modal/ssh). OraHermes does "
    "not support local file-backed boards; if the Kanban tools are absent, "
    "block immediately and ask for an Oracle-backed board to be configured.\n"
    "\n"
    "## Lifecycle\n"
    "\n"
