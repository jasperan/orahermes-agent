...
* :func:`compress_context` — the actual compression call.  Runs the
  configured compressor, splits the Oracle session, rotates the
...
def compress_context(
    ...
    *,
    ...
    """Compress conversation context and split the session in Oracle.
    ...
    # so any provider-cached per-session state refreshes. reset=False because
