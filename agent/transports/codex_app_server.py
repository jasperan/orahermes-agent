...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        # the board backend, which may live outside the per-task workspace.
        # Keep the Codex sandbox on, but add the Kanban root as the only
        # extra writable root for file-backed board assets.
