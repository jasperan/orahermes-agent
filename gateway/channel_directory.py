...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    """Pull known channels/contacts from Oracle-backed session origin data."""
    entries = []
    try:
        ...
        logger.debug("Channel directory: failed to read Oracle sessions for %s: %s", platform_name, e)
