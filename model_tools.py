...
from tools.registry import discover_builtin_tools, get_check_fn_cache_token, registry
...
#   - run_agent.py             -> direct hermes-agent/python entry point
