...
def get_optional_skills_dir(default: Path | None = None) -> Path:
    ...
    if default is not None and default.exists():
        return default
    installed_package_dir = Path(__file__).parent / "optional-skills"
    if installed_package_dir.exists():
        return installed_package_dir
    installed_data_dir = Path(sys.prefix) / "optional-skills"
    if installed_data_dir.exists():
