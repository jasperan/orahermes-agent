...
- **Response storage** — stored responses (for `previous_response_id`) are persisted in Oracle Database and survive gateway restarts. Max 100 stored responses (LRU eviction).
