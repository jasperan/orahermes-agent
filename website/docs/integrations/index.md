...
- **[Memory](/docs/user-guide/features/memory)** — OraHermes disables local file-backed memory and uses Oracle Database for runtime persistence.
- **[Memory](/docs/user-guide/features/memory)** — OraHermes uses Oracle Database as the only runtime persistence backend. External memory backends are disabled.
