...
Sessions are persisted to the shared Oracle-backed SessionDB so they
...
class SessionManager:
    ...
    def __init__(self, agent_factory=None, db=None):
        ...
        Args:
            ...
            db:            Optional SessionDB instance. When omitted, the
                           Oracle-backed SessionDB is lazily created.
        """
    ...
    def _get_db(self):
        ...
        Oracle configuration is resolved by ``SessionDB`` at initialization.
        OraHermes requires Oracle persistence; initialization failures are
        allowed to abort the ACP session instead of falling back to in-memory
        persistence.
        """
    ...
    def _persist(self, state: SessionState) -> None:
        ...
        try:
            ...
            if existing is None:
                ...
                try:
                    db.update_session_model_config(
                        state.session_id,
                        session_meta,
                        model=model_str,
                    )
