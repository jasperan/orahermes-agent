...
TIPS = [
    ...
    "OraHermes stores runtime session state in Oracle Database only; local and external memory providers are disabled.",
    ...
    # --- Plugins ---
    "Plugin types: general plugins (tools/hooks) and context engines. Memory-provider plugins are disabled in OraHermes.",
    "hermes plugins install owner/repo installs plugins directly from GitHub.",
    "hermes memory status shows the Oracle-only memory-provider policy.",
