...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            ...
            "5. E2EE is disabled in OraHermes until its crypto store is Oracle-backed",
...
def _all_platforms() -> list[dict]:
    ...
    every host. Currently:
      - Matrix E2EE is hidden/disabled in OraHermes until its crypto store
        is ported to Oracle-backed persistence. Plain Matrix messaging can
        still be configured where mautrix is installable.
    """
